...
public:
    ...
    inline NiVec4() : x(), y(), z(), w() {};

    inline NiVec4(const float& _x, const float& _y, const float& _z, const float& _w)
    {
        x = _x;
        y = _y;
        z = _z;
    ...
    inline NiVec4(const float& _x, const float& _y, const float& _z)
    {
        x = _x;
        y = _y;
        z = _z;
    ...
    inline NiVec4(const float& _x, const float& _y)
    {
        x = _x;
        y = _y;
        z = 0.0f;
    ...
    inline NiVec4(const NiVec3& _vec3)
    {
        x = _vec3.x;
        y = _vec3.y;
        z = _vec3.z;
    ...
    inline NiVec4(const NiVec2& _vec2)
    {
        x = _vec2.x;
        y = _vec2.y;
        z = 0.0f;
    ...
    inline NiVec3 xyz() const { return NiVec3(x, y, z); }

    inline NiVec2 xy() const { return NiVec2(x, y); }
