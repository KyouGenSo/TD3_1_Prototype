...
void ResultScene::Initialize()
{
    ...
    emitterManager_->SetEmitterColors("bg", Vector4(1.f, 1.f, 1.f, 1.0f), Vector4(229.f / 255.f, 0.f, 70.0f / 255.f, 1.f));
    ...
    overText_ = std::make_unique<Sprite>();
    overText_->Initialize("GameOver.png");
    overText_->SetPos(overPos);
...
void ResultScene::Update()
{
    ...
    overPos.x = WinApp::clientWidth / 2 - overText_->GetSize().x / 2;
    overPos.y = overText_->GetSize().y + 100.f;
    overText_->SetPos(overPos);
    overText_->Update();
