...
public:
    ...
    void Initialize(const std::string& _nameTexturePath);
    void Update();
    void Draw2D();
    void ImGui();
...
private:
    ...
    static constexpr char PATH_DECORATION[] = "hud/bar_deco.png";
